    ...
    <section class="featured spad">
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <li data-filter=".filter{{$row->id}}">{{$row->category_name}}</li>   
                            @endforeach
            ...
            <div class="row featured__filter">
                ...
                @php
                  $products=App\Product::where('category_id',$row->id)->where('status',1)->latest()->get();  
                @endphp
                @foreach ($products as $product)
                    
                <div class="col-lg-3 col-md-4 col-sm-6 mix filter{{$row->id}}">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="{{asset($product->image_one)}}">
                            <ul class="featured__item__pic__hover">
                                <li><a href="{{route('add_wishlist',['id'=>$product->id,'price'=> $product->price])}}"><i class="fa fa-heart"></i></a></li>
                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                <li><a href="{{route('add.card',['id'=> $product->id,'price'=> $product->price])}}"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                        </div>
                    ...
                    <div class="latest-product__text">
                        ...
                        <div class="latest-product__slider owl-carousel">
                            <div class="latest-prdouct__slider__item">
                                @php
                                  $lats = App\Product::where('status',1)->latest()->limit(3)->get();  
                                @endphp
                                @foreach ($lats as $row )
