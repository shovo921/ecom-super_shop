    ...
    <div class="wd-300">
      <div class="d-flex mg-b-30">
        <div class="form-group mg-b-0">
          ...
          <input type="text" name="coupon_name" class="form-control wd-250 @error('coupon_name') is-invalid
          ...
          <input type="text" name="coupon_discount" class="form-control wd-250 @error('coupon_discount') is-invalid
