    ...
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item "><a href="{{route('admin.category.index')}}" class="nav-link @yield('category1')">All Category</a></li>
          <li class="nav-item "><a href="{{route('admin.category.add')}}" class="nav-link @yield('category2')">Add Category</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item "><a href="{{route('admin.brand.index')}}" class="nav-link @yield('brand1')">All Brand</a></li>
          <li class="nav-item "><a href="{{route('admin.brand.add')}}" class="nav-link @yield('brand2')">Add Brand</a></li>
       ...
       <i class="menu-item-icon ion-ios-pie-outline tx-20"></i>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item "><a href="{{route('admin.product.manage')}}" class="nav-link @yield('product1')">Manage Product</a></li>
          <li class="nav-item "><a href="{{route('admin.product.add')}}" class="nav-link @yield('product2')">Add Product</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item "><a href="{{route('admin.coupon.index')}}" class="nav-link @yield('coupon1')">All Coupon</a></li>
          <li class="nav-item "><a href="{{route('admin.coupon.add')}}" class="nav-link @yield('coupon2')">Add Coupon</a></li>
       
        </ul>
        <a href="{{route('subscribe.index')}}" class="sl-menu-link @yield('subscribe')"  >
          <div class="sl-menu-item">
        ...
        <a href="#" class="sl-menu-link @yield('class-active')">
          <div class="sl-menu-item">
