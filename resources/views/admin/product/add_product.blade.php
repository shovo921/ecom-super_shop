              ...
              <div class="form-layout">
                <div class="row mg-b-25">
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="product_name" placeholder="Enter name">
                      @error('product_name')
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="product_code"  placeholder="Enter code name">
                      @error('product_code')
                        <strong class="text-danger">{{$message}}</strong>
                      @enderror
                    </div>
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="number" name="product_quantity"  placeholder="Enter code name">
                  ...
                  <div class="col-lg-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="product_price"  placeholder="Enter price ">
                      @error('product_price')
                        <strong class="text-danger">{{$message}}</strong>
                      @enderror
                    </div>
                ...
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <textarea name="long_description" id="summernote1"></textarea>
